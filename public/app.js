...
(function () {
  ...
  function previewProposalDoc(doc) {
    ...
    (d.lines || []).forEach(function (l) {
      ...
      if (lt === 'SUBGROUP') { body += '<tr style="break-inside:avoid;break-after:avoid;"><td colspan="5" style="padding:7px 8px 3px;font-weight:600;font-size:11.5px;color:#3d4a55;border-bottom:1px solid #d5d8d2;">' + esc(tc(l.name)) + '</td></tr>'; return; }
      ...
      body += '<tr style="break-inside:avoid;"><td style="padding:5px 8px;border-bottom:1px solid #eef0ea;vertical-align:top;"><b style="font-weight:600;">' + esc(tc(l.name)) + '</b>' + (l.description ? '<div style="font-size:10.5px;color:#5c6157;line-height:1.45;margin-top:2px;">' + esc(l.description) + '</div>' : '') +
