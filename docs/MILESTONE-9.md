...
- Threshold _detection_ (what discount % or margin triggers an approval) is produced by the pricing engine (Milestone 7, `REQUIRE_APPROVAL` findings); this milestone consumes that signal and manages the human decision.
