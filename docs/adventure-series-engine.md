...
```
mat inches  = (lengthFt × 12 + 14) × (widthFt × 12 + 14)   // 14" added to EACH side
square feet = square inches ÷ 144
cost        = square feet × cost/sq ft        (3.25" = $11.78 · 2" = $7.65)
sell price  = cost × 1.4                       // 140% markup
```

Worked example — 8' × 8' × 3.25": 110" × 110" = 12,100 sq in ÷ 144 = 84.03 sq ft
× $11.78 = **$989.85 cost** → × 1.4 = **$1,385.79 sell**.

Part number: `R-SSG-{LLWW}CLM` (length then width, each zero-padded to two digits),
with `-2` appended for the 2" pad — e.g. `R-SSG-0808CLM` and `R-SSG-0808CLM-2`.
