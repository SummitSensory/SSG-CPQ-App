...
**Retest:** open a proposal preview, a Canadian proposal preview, print, and the server PDF. All four must be byte-identical to before.
...
| 2026-08-28 | AUD-020: ten script tags missing from `CLIENT_SCRIPTS` (incl. `insights.js`, `goals.js`)                                                                                                                        | Fixed. Local-dev 404s only — production serves `public/` from the CDN                                                                                                                                                                                                                                                                                           |
