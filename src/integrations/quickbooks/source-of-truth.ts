...
export const QBO_SOURCE_OF_TRUTH: FieldSot[] = [
  // --- CPQ-authoritative (pushed to QuickBooks, never read back) ---
  {
    ...
    owner: 'CPQ',
    sync: 'CPQ_TO_QBO',
    note: 'Organization name; QBO customer created/matched from it.',
  },
  {
    field: 'customer.billingAddress',
    owner: 'CPQ',
    sync: 'CPQ_TO_QBO',
    note: 'From CRM billing address.',
  },
  {
    field: 'customer.shippingAddress',
    owner: 'CPQ',
    sync: 'CPQ_TO_QBO',
    note: 'From CRM shipping address.',
  },
  { field: 'customer.email', owner: 'CPQ', sync: 'CPQ_TO_QBO', note: 'Primary contact email.' },
  {
    ...
    owner: 'CPQ',
    sync: 'CPQ_TO_QBO',
    note: 'Product/service name (approved catalog sync only).',
  },
  {
    field: 'item.sku',
    owner: 'CPQ',
    sync: 'CPQ_TO_QBO',
    note: 'Product SKU maps to QBO Item Sku.',
  },
  {
    field: 'estimate.lines',
    owner: 'CPQ',
    sync: 'CPQ_TO_QBO',
    note: 'Line items come from the accepted proposal — frozen.',
  },
  {
    field: 'estimate.total',
    owner: 'CPQ',
    sync: 'CPQ_TO_QBO',
    note: 'Accepted proposal grand total — never altered.',
  },
  {
    field: 'invoice.amount',
    owner: 'CPQ',
    sync: 'CPQ_TO_QBO',
    note: 'Deposit/progress/final portion from the frozen payment schedule.',
  },
  ...
  {
    field: 'transaction.qboId',
    owner: 'QBO',
    sync: 'QBO_TO_CPQ',
    note: 'QuickBooks-assigned object id; stored on QboTransaction.',
  },
  {
    field: 'transaction.docNumber',
    owner: 'QBO',
    sync: 'QBO_TO_CPQ',
    note: 'QuickBooks document number.',
  },
  {
    field: 'invoice.paymentStatus',
    owner: 'QBO',
    sync: 'QBO_TO_CPQ',
    note: 'Paid / partially paid / open — reconciliation display only.',
  },
  {
    field: 'invoice.balance',
    owner: 'QBO',
    sync: 'QBO_TO_CPQ',
    note: 'Outstanding balance — reconciliation display only.',
  },
  {
    field: 'customer.qboId',
    owner: 'QBO',
    sync: 'QBO_TO_CPQ',
    note: 'QuickBooks customer id; stored on QboEntityLink.',
  },
];
